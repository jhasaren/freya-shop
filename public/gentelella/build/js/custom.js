...
$(document).ready(function () {    
    ...
    $('.btn-producto').click(function (e) {
        ...
        $('#myModal-producto').on("shown.bs.modal", function() {
            $('#barcode').focus();
        });
    ...
    /*Accion lectura codigo barras -no submit-*/
    $('#barcode, #idproducto').on('keyup', function(e) {
        e.preventDefault();
        $(':submit').attr('disabled', 'disabled');
        console.log("barcode read success");
    });
    /*Accion codigo barras -habilitar submit-*/
    $('#barcode, #idproducto').on('blur', function(e) {
        e.preventDefault();
    ...
    $('.btn-empleado').click(function (e) {
        e.preventDefault();
        $('#myModal-e').modal('show');
    });
    /*Modal - Agregar Cliente Venta*/
    $('.btn-saleclient').click(function (e) {
        e.preventDefault();
        //$('#idcliente').focus();
        //$('#myModal-c').modal('show');
        
        //to have your input focused every your modal open
        $('#myModal-c').on("shown.bs.modal", function() {
            $('#idcliente').focus();
        });
    ...
    $('.btn-saleespecial').click(function (e) {
        ...
        //to have your input focused every your modal open
        $('#myModal-esp').on("shown.bs.modal", function() {
            $('#motivo').focus();
        });
    ...
    $('.btn-saledesc').click(function (e) {
        ...
        //to have your input focused every your modal open
        $('#myModal-desc').on("shown.bs.modal", function() {
            $('#procentaje').focus();
        });
    ...
    /*Modal - Nuevo Cliente en Venta*/
    $('.btn-newcliente').click(function (e) {
        e.preventDefault();
        $('#myModal-nc').modal('show');
    });
    /*Modal - Ayuda*/
    ...
    /*Modal - Confirmacion cancelar cita*/

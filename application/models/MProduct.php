...
class MProduct extends CI_Model {
     ...
     * Fecha Creacion: 25/03/2017, Ultima modificacion: 
     **************************************************************************/
    public function create_product($name,$valor,$distributionproduct,$stock,$unidosis,$typeproduct,$costo,$undmedida,$groupservice,$barcode) {
     ...
     * Fecha Creacion: 25/03/2017, Ultima modificacion: 
     **************************************************************************/
    public function update_product($idproduct,$name,$valor,$procent_empleado,$stock,$unidosis,$valueState,$costo,$inventario,$barcode) {
    ...
    /**************************************************************************
     * Nombre del Metodo: list_cat_app
     * Descripcion: Consulta servicio web Catalogo App (exclusivo Carrusel)
     * Autor: jhonalexander90@gmail.com
     * Fecha Creacion: 08/03/2021, Ultima modificacion: 
     **************************************************************************/
    public function list_cat_app() {
        
        $curl = curl_init();

        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://tiendacarrusel.com/api/Widgets/getListType',
          ...
          CURLOPT_HTTPHEADER => array(
            'Authorization: Basic YXBpY2FycnVzZWw6NHAxQzRycnUkM0w='
          ),
        ));
        ...
        curl_close($curl);
        $dataRequest = json_decode($response);        
        return $dataRequest;

    }
    
    /**************************************************************************
     * Nombre del Metodo: create_product_app
     * Descripcion: Crear producto en Catalogo App (exclusivo Carrusel)
     * Autor: jhonalexander90@gmail.com
     * Fecha Creacion: 08/03/2021, Ultima modificacion: 
     **************************************************************************/
    public function create_product_app($ref,$name) {
        
        $curl = curl_init();

        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://tiendacarrusel.com/api/Widgets/addProduct',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
          ...
          CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
          CURLOPT_CUSTOMREQUEST => 'POST',
          CURLOPT_POSTFIELDS => array('ref' => $ref,'name' => $name,'desc' => 'Pendiente','tags' => 'Pendiente','valueApp' => '0','valueWeb' => '0','category' => '1','star' => 'N'),
          CURLOPT_HTTPHEADER => array(
            'Authorization: Basic YXBpY2FycnVzZWw6NHAxQzRycnUkM0w='
          ),
        ));

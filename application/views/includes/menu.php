<div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
        <a href="<?php echo base_url().'index.php/CPrincipal'; ?>" class="site_title"><img src="<?php echo base_url().'public/img/logo-menu.png'; ?>"> <span><?php echo $this->config->item('namebussines'); ?></span></a>
        ...
        <div class="menu_section">
            ...
            <ul class="nav side-menu">
                ...
                <li>
                    ...
                    <?php } else { ?>
                        <?php if ($this->config->item('tipo_negocio') == 2) { ?>
                            <a href="<?php echo base_url().'index.php/CService'; ?>">
                                <i class="fa fa-star-half-o"></i> Producto Principal
                            </a>
                        <?php } ?>
                    <?php } ?>
                </li>
                ...
                <li>
                    ...
                    <?php } else { ?>
                        <a href="<?php echo base_url().'index.php/CProduct'; ?>">
                            <i class="fa fa-shopping-cart"></i> Artículos <br />Inventario
                        </a>
                    <?php }  ?>
                </li>
...
<!--                <li><a><i class="fa fa-bar-chart-o"></i> Reportes <span class="fa fa-chevron-down"></span></a>
                ...
                <?php if ($this->config->item('fidelizacion') == 1) { ?>
...
<!--        <a data-toggle="tooltip" data-placement="top" title="Settings">
        ...
        <a data-toggle="tooltip" data-placement="top" title="Version 1.5.0" href="#">
